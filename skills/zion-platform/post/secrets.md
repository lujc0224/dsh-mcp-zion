...
```bash
npx -y zion-mcp@2.6.2 secret save-value --displayName "OpenAI API key"   # create a secret and set its value
npx -y zion-mcp@2.6.2 secret save-value --secretId <id>                  # set / replace an existing secret's value
```
