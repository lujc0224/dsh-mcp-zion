...
## Querying Zion data (auto-generated GraphQL over PostgreSQL)
...
authenticates THIS CLI to Zion. Zion apps conventionally sign up / log in by phone number (SMS code); email and username work too.
